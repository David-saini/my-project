            ...
            <div className="max-w-[1164px] mx-auto px-5 md:px-3 relative z-[50]">
                <div className='flex items-center md:justify-between justify-center flex-wrap md:gap-[31px]'>
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className='ff_CircularStd text-[#797979] text-base md:text-[18px] leading-[150%] md:max-w-[455px] lg:max-w-[551px] mt-[14px] md:mt-5'>Chat easily with people interested and the business all in one place. All chats are group chats so business hosts can build excitment and guide customers before a promo.</p>
