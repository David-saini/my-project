            ...
            <div className='max-w-[1164px] mx-auto px-5 sm:px-3 z-10 relative'>
                ...
                <div className='flex items-center justify-center flex-wrap w-full gap-[15px] xl:gap-6 mt-[25px] sm:mt-[30px] md:mt-[40px] lg:mt-[50px]'>
                    <div className='bg-white border border-white rounded-[10px] max-w-[558px] xl:max-w-[364px] w-full card_shadow xl:min-h-[321px]'>
                        ...
                        <p className='max-w-[314px] text-center mx-auto ff_CircularStd text-[#797979] text-[14px] px-3 sm:text-base !leading-[140%] pb-5 xl:pb-0'>Incentive helps companies offer deep discounts to customers.</p>
                    </div>
                    ...
                    <div className='bg-white border border-white rounded-[10px] max-w-[558px] xl:max-w-[364px] w-full card_shadow xl:min-h-[321px]'>
                        ...
                        <p className='px-5 xl:px-0 xl:max-w-[314px] text-center mx-auto ff_CircularStd text-[#797979] text-[14px] sm:text-base !leading-[140%] pb-5 xl:pb-0'>Use social media or any other platform via an Invite Link or Code people can enter to sign up and automatically get invited to take advantage of the discount. Meaning you can scale promotions from flyers, conferences, or impromptu interactions to dive deeper with customers.</p>
                    </div>
                    ...
                    <div className='bg-white border border-white rounded-[10px] max-w-[558px] w-full card_shadow xl:min-h-[321px]'>
                        ...
                        <p className='max-w-[508px] text-center mx-auto ff_CircularStd text-[14px] sm:text-base px-[20px] text-[#797979] !leading-[140%] pb-5 xl:pb-0'>Promotions ensure more reliable sales and getting feedback for brick and mortar as well as online stores. Do away with finnicky online ads or promoting with click based platforms.</p>
                    </div>
