        ...
        <div className='max-w-[1440px] mx-auto relative z-[60]'>
            ...
            <div className='max-w-[1164px] mx-auto px-5 sm:px-3 z-10 relative'>
                ...
                <div className='flex items-center justify-center flex-wrap w-full gap-[15px] xl:gap-6 mt-[25px] sm:mt-[30px] md:mt-[40px] lg:mt-[50px]'>
                    ...
                    <div className='bg-white border border-white rounded-[10px] max-w-[364px] w-full card_shadow md:min-h-[321px] hover:scale-[1.05] duration-300 cursor-pointer'>
                    ...
                    <div className='bg-white border border-white rounded-[10px] max-w-[364px] xl:max-w-[558px] w-full card_shadow md:min-h-[321px] hover:scale-[1.05] duration-300 cursor-pointer'>
